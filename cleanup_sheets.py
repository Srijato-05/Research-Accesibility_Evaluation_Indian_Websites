...
def cleanup_google_sheets_data():
    ...
    for col in violation_cols:
        if col in scores_df.columns:
            ...
            print(f"Warning: Column '{col}' not found in 'Accessibility_Scores' sheet. It will be ignored.")

    # --- CORRECTED LOGIC ---
    # The order is now from worst to best, so 'min()' will find the true weakest link.
