...
def analyze_page(driver, url):
    ...
    try:
        # --- CORRECTED: Ensure the URL has a protocol (https://) ---
...
def process_analysis_results(results):
    """Processes Axe results to count violations and determine compliance level."""
    ...
    return {'highest_pass_level': highest_pass_level, 'violations': counts, 'severity': severity}